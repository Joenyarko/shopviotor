        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-5 pr-0 md:pr-12">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.tiktok.com/@viotor.trading.en?_r=1&_t=ZS-98kSSXidknM" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:text-white hover:border-white hover:bg-white/10 transition-all">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.04.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.12-3.44-3.17-3.64-5.46-.22-2.12.59-4.32 2.11-5.74 1.18-1.12 2.82-1.76 4.45-1.74.02.04.05.08.08.12v4.06c-1.04-.15-2.11.16-2.91.85-.64.55-1.05 1.34-1.13 2.19-.1 1.05.34 2.13 1.11 2.8.76.66 1.83.89 2.8.69.96-.21 1.74-.89 2.14-1.79.25-.56.36-1.18.38-1.8.01-4.99.01-9.98.01-14.97-.02-.03-.04-.06-.06-.09z"/></svg>
              </a>
            </div>
          </div>
