...
const HeroBanner = ({ position, fallbackContent }) => {
  ...
  if (loading) {
    return (
      <div className="relative rounded-2xl overflow-hidden bg-secondary-200 dark:bg-secondary-800 animate-pulse aspect-[16/9] sm:aspect-[21/9] lg:aspect-[3/1] max-h-[450px] shadow-lg mx-4"></div>
    );
  }
  ...
  if (banners.length > 0) {
    return (
      <div className="w-full py-2">
        <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] lg:aspect-[3/1] max-h-[450px] overflow-hidden">
          <div 
            ref={carouselRef}
