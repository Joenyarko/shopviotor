    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-2 sm:gap-3 pb-4 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-4 lg:grid-cols-6">
            {featured.slice(0, 10).map(product => (
              <div key={product.id || product.uuid} className="min-w-[150px] w-[45%] sm:w-[30%] flex-none snap-start md:w-auto md:min-w-0">
