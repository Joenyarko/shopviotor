    ...
    <div className="max-w-md mx-auto text-center py-20 dark:text-white space-y-6">
      ...
      {status === 'verifying' && (
        <div className="space-y-4">
          ...
          <p className="text-sm text-secondary-500">Communicating with {gateway} payment gateway.</p>
        </div>
      )}
      ...
      {status === 'success' && (
        <div className="space-y-4">
          ...
          <p className="text-sm text-secondary-500">Thank you for your trade. Your order is confirmed.</p>
