    ...
    <div className="max-w-4xl mx-auto space-y-8 py-12 px-4">
      ...
      <div className="space-y-6 text-secondary-700 dark:text-secondary-300">
        <section className="space-y-3">
          ...
          <p>
            As an online marketplace, Shop Viotor holds payments in escrow to protect both buyers and sellers. Our refund policy depends on the nature of the transaction:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Barter Trades:</strong> Barter trades are final once both parties accept and swap items. However, if a user misrepresents their item, Shop Viotor will step in to mediate the dispute.</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Shop Viotor acts as a neutral mediator in disputes between buyers and vendors. If a buyer is dissatisfied with a purchase, they must open a dispute by contacting us directly via WhatsApp or Email within 48 hours of delivery. 
          </p>
          <p>
            During a dispute:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>If the vendor is found at fault (e.g., selling defective goods), the buyer will return the item, and Shop Viotor will issue a full refund to the buyer.</li>
        ...
        <section className="space-y-3">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>Contact Shop Viotor Support via WhatsApp or Email within 48 hours of receiving the item.</li>
            <li>Provide your order/transaction ID and clear evidence of the issue (photos/videos).</li>
            <li>Once approved, you will receive instructions on how to return the item to the vendor or a Shop Viotor hub.</li>
