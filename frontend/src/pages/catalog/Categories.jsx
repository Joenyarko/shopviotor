          ...
          {activeCategory?.children && activeCategory.children.length > 0 ? (
            ...
            <div className="space-y-4">
              {loadingProds ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-px bg-secondary-200 dark:bg-secondary-800 border-t border-secondary-200 dark:border-secondary-800">
