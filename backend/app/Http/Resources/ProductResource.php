...
class ProductResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'hp_interest_rate'            => $this->hp_interest_rate,
            'hp_min_deposit_percent'      => $this->hp_min_deposit_percent,
            'hp_max_duration_months'      => $this->hp_max_duration_months,
            'available_for_trade'         => $this->available_for_trade,
            'is_layaway'                  => $this->is_layaway,
            'available_for_layaway'       => $this->available_for_layaway,
            'layaway_boxes'               => $this->layaway_boxes,
